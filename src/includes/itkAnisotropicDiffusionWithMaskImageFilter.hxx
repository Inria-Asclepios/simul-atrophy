 ...
 *
 *=========================================================================*/
#ifndef __itkAnisotropicDiffusionWithMaskImageFilter_hxx
#define __itkAnisotropicDiffusionWithMaskImageFilter_hxx
...
AnisotropicDiffusionWithMaskImageFilter< TInputImage, TOutputImage >
...
::InitializeIteration()
{
  AnisotropicDiffusionWithMaskFunction< UpdateBufferType > *f =
    dynamic_cast< AnisotropicDiffusionWithMaskFunction< UpdateBufferType > * >
  ...
  f->SetConductanceImage(m_ConductanceImage);
