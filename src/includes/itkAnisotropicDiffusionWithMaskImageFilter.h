 ...
 *
 *=========================================================================*/
#ifndef __itkAnisotropicDiffusionWithMaskImageFilter_h
#define __itkAnisotropicDiffusionWithMaskImageFilter_h
...
namespace itk
{
/** \class AnisotropicDiffusionWithMaskImageFilter
 ...
 *  AnisotropicImageFunction.  AnisotropicDiffusionWithMaskImageFilter is a subclass
 ...
 *  This parameter is described in detail in itkAnisotropicDiffusionWithMaskFunction.
 ...
 *  itkAnisotropicDiffusionWithMaskFunction.   See itkAnisotropicDiffusionWithMaskFunction for
 *  detailed information.
 *
 *  \par How to use this filter
 *  AnisotropicDiffusionWithMaskImageFilter must be subclassed to be used.  This class
 *  implements a generic framework for other diffusion filters.
 *
 *  \sa GradientAnisotropicDiffusionWithMaskImageFilter
...
public:
  ...
  typedef AnisotropicDiffusionWithMaskImageFilter                               Self;
  typedef DenseFiniteDifferenceImageFilter< TInputImage, TOutputImage > Superclass;
  typedef SmartPointer< Self >                                          Pointer;
  typedef SmartPointer< const Self >                                    ConstPointer;

  /** Run-time type information. */
  itkTypeMacro(AnisotropicDiffusionWithMaskImageFilter,
  ...
  typename InputImageType::Pointer GetConductanceImage() {
      return m_ConductanceImage;
  }
...
#include "itkAnisotropicDiffusionWithMaskImageFilter.hxx"
#endif
