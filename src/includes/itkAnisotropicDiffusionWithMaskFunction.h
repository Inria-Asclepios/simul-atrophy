 ...
 *
 *=========================================================================*/
#ifndef __itkAnisotropicDiffusionWithMaskFunction_h
#define __itkAnisotropicDiffusionWithMaskFunction_h
...
{
/**
 * \class AnisotropicDiffusionWithMaskFunction
 ...
 * AnisotropicDiffusionWithMaskFunction objects are used by
 ...
 *  diffusion equation described in AnisotropicDiffusionWithMaskFunction.  Variations
...
public:
  ...
  typedef AnisotropicDiffusionWithMaskFunction       Self;
  typedef FiniteDifferenceFunction< TImage > Superclass;
  typedef SmartPointer< Self >               Pointer;
  typedef SmartPointer< const Self >         ConstPointer;

  /** Run-time type information (and related methods) */
  itkTypeMacro(AnisotropicDiffusionWithMaskFunction, FiniteDifferenceFunction);
  ...
  /** Set/Get the conductance image. */
  void SetConductanceImage(const typename ImageType::Pointer conductanceImage) {
      m_ConductanceImage = conductanceImage;
  }

  typename ImageType::Pointer GetConductanceImage() {
...
protected:
  typename ImageType::Pointer m_ConductanceImage;
