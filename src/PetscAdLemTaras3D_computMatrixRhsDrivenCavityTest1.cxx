//Driven cavity test with Dirichlet condition, eliminating the
//identity rows in the matrix for the Dirichlet boundaries. i.e.
//Computed domain is only for interior points.
